...
def Main(args):
  ...
  names = ['tracing.ui.extras.kudu_tracing.kudu_tracing']
  ...
  try:
    ...
    o = codecs.open(os.path.join(args.out_dir, 'tracing.html'), 'w',
                    encoding='utf-8')
    try:
    ...
    o = codecs.open(os.path.join(args.out_dir, 'tracing.js'), 'w',
                    encoding='utf-8')
